        ...
        <div className={s.portfolio}>
            <div className={s.portfolio__container}>
                ...
                <div className={s.projects}>
                    <Project background={bgTodoList}  addressProject={'https://DmitryKhiliuk.github.io/ToDo.git'} addressCode={'https://github.com/DmitryKhiliuk/ToDo'}  title={'Todolist'} text={'Technologies: TypeScript, Redux Toolkit, RestAPI, Redux-thunk, Material UI, Unit Tests, Storybook'}/>
