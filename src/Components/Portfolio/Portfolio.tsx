        ...
        <div className={s.portfolio}>
            <div className={s.portfolio__container}>
                ...
                <div className={s.projects}>
                    ...
                    <Project background={bgSocialNetwork} addressProject={'https://DmitryKhiliuk.github.io/samuraiWay'} addressCode={'https://github.com/DmitryKhiliuk/samuraiWay.git'} title={'Social Network'} text={'Technologies: TypeScript, React, Redux, Redux-thunk, Redux-form, Axios, Reselect, SCSS. Use common test account credentials: Email: free@samuraijs.com Password: free'}/>
